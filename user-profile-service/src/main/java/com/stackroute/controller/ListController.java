...
public class ListController
{
    ...
    @Autowired
    public ListController(ListedService listedService,  BookedService bookedService, ActivityStream activityStream) {
    ...
    @PostMapping("/savestorage")
       public ResponseEntity<?> addListedStorageUnit(@RequestBody ListedStorageUnit listedStorageUnit) throws StorageUnitAlreadyExistsException {
        ...
        try {
            ...
            responseEntity= new ResponseEntity ("Storage Space Successfully created in Listed Storage Unit", HttpStatus.CREATED);
