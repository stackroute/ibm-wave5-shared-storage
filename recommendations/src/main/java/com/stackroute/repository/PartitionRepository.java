...
public interface PartitionRepository extends Neo4jRepository<Partition,Integer> {
   ...
   @Query("CREATE (p:Partition) SET p.pid={pid},p.sqft={sqft},p.cost={cost}, p.cityName={cityName}, p.uuid={uuid}")
   Partition createPartition(long pid, long sqft, long cost, String cityName, String uuid);
